...
void loop() {
  ...
  elapsedTime = (currentTime - previousTime) / float(1000); // Divide by 1000 to get seconds
  Wire.beginTransmission(MPU);
  ...
  GyroX = GyroX - 493.96; // GyroErrorX ~(-0.56)
  GyroY = GyroY - 495.35; // GyroErrorY ~(2)
  GyroZ = GyroZ - 494.51; // GyroErrorZ ~ (-0.8)
